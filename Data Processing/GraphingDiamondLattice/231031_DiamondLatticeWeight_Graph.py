...
path = '/GraphingDiamondLattice/DiamondLattice_AllWeights.txt'

upper_weight_range = 2.5344
lower_weight_range = 2.3836#36
average_weight = ((upper_weight_range+lower_weight_range)/2)

upper_weight_range_large = 2.5 + 0.125
lower_weight_range_large = 2.5 - 0.125
