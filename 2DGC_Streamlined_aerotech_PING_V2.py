...
resync_number = 5 # number of directions changes between resyncing
...
if __name__ == '__main__':
    ...
    while (i < len(command_dict_final)):
        ...
        if bytesToRead > 0:
            ...
            python_receive_list.append(python_recieved_time)

            #add_time = message - times_of_resync[count]
    ...
    # times_of_resync.insert(0,0)
    print("time stamps from aerotech = ", message_list)
    print('python received time stamps = ', python_receive_list)
    ...
    for i in range(len(times_of_resync)):
        diff_resync = message_list[i] - times_of_resync[i]
        ...
        diff_resync_list.append(diff_resync)
