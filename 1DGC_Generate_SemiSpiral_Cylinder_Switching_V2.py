...
num_layers = 3
reverse = "G2" # Options: "G2" (reverse the spiral direction each layer) or "G3" continue in ccw direction
...
for l in range(num_layers):
    ...
    if (l+1)%2 != 0: #odd layers
        ...
        while circle_diam < circle_diam_outer:
            ...
            if odd_2 == False:  # starting loop is odd
                loop = circle_diam
            else:
                loop = - circle_diam
            ...
            if circle_diam == circle_diam_outer:
                Gcommand_list.append("G3")
                if odd == True:
                    last_loop = loop
                else:
                ...
                X_list.append(last_loop/2)
                I_list.append((last_loop) / 2)
                Y_list.append(-last_loop/2)
                Z_list.append(0)
                J_list.append(0)
        ...
        while circle_diam > circle_diam_inner:
            ...
            if (i + 1) % 2 != 0:  ## odd lines
                ...
                if odd == True:
                    Y_list.append(circle_diam)
                    J_list.append(circle_diam / 2)
                    odd_2 = True
                else:
                    Y_list.append(-circle_diam)
                    J_list.append(-circle_diam / 2)
            ...
            if circle_diam == circle_diam_inner:
                Gcommand_list.append(reverse)
                circle_diam_last = circle_diam

                if odd_2 == True:
                    last_loop = - circle_diam_last
                else:
                    last_loop =  circle_diam_last
