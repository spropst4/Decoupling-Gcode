...
export_gcode_txt = "Aerotech_SemiSpiral_Switching_gcode.txt"
...
pressure = [27.5, 27.5] # 1 is core, 2 is shell
com = [4, 5] #core 1, shell 2

## Are you applying offsets?
apply_offset = True
offset = 3.75                                    # 1.4  # for F=15 #2.5mm for F=25
...
setpress1 = str('\n\rFILEWRITE ' + str(file_name[0]) + ", "+ str(setpress(pressure[0])) + " 'M1: P = " + str(pressure[0])+ " psi") #set pressure material 1 - CORE
setpress2 = str('\n\rFILEWRITE ' + str(file_name[1]) + ", "+ str(setpress(pressure[1])) + " 'M2 P = " + str(pressure[1])+ " psi") #set pressure material 1 - CORE

toggleON_1 = str('\n\rFILEWRITE ' + str(file_name[0]) + ", "+ str(togglepress())+ " 'M1 ON")# turn on material Core
toggleOFF_1 = str('\n\rFILEWRITE ' + str(file_name[0]) + ", "+ str(togglepress())+ " 'M1 OFF")

toggleON_2 = str('\n\rFILEWRITE ' + str(file_name[1]) + ", "+ str(togglepress())+ " 'M2 ON")  # turn on shell
...
circle_diam = circle_diam_outer
while circle_diam > 4*filament_width:
    if i > 0:
...
with open(export_gcode_txt, type_open) as f:
    f.write("\n\rG0 X"+str(circle_diam_outer) + " Y"+str(circle_diam_outer) )
    f.write(setpress1)
    f.write(setpress2)
    f.write(toggleON_1)
    #f.write(toggleON_2)
