...
##INPUTS#############################################################################################################
export_gcode_txt = "TESTGenerate_Checkerboard_SwitchingNozzle_gcode.txt"
...
def write_press_command(com, command):
    return str('\n\r' + com + '.write(' + str(command) + ')')

#setpress1 = str('\n\r' + com[0] + '.write(' + str(setpress(pressure[0])) + ')') # material 1

setpress1 = write_press_command(com[0], setpress(pressure[0]))
