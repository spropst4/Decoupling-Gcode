...
def Gradient_line_segmentation(input_line, gradient_fraction, segments, pressure_range, valveON, valveOFF):
    ###
    prev_pressure = pressure_range[1]
...
if __name__ == '__main__':
    ### File names
    export_file = '231027_GradientBand_A_ThickBand_NG_gcode.txt'
    ...
    pressure_range = [25, 19]#[16, 24]  # [center of print, outside edge of print]
    NG_pressure = 22
