...
'''Colors'''
color_results = find_colors(path + '\\' + image_list[1], scale_factor)
...
avg_color = find_average_curve(pixel_color_list)
std = find_std_error(pixel_color_list)
std_lower = std[2]
std_upper = std[1]
print(len(std_lower), len(avg_color), len(width_list[0]))
