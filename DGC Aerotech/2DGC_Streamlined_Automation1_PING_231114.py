...
offset = 0  # 0.45 #0.5 #2.92 #3.75 #2.5 #use a negative number to increase length of time/material being on (units in mm)
offset_initial = offset  # 5 #3.5
start_delay = 0  # (units in mm)

gcode_txt_imported = '231114_1DGC_Generate_Checkerboard_M1_gcode.txt'  # "1DGC_Generate_Gradient_M1_gcode.txt" #"1DGC_Generate_Checkerboard_SwitchingNozzle_gcode.txt" #"1DGC_Generate_Checkerboard_M1.txt"
...
num_initial_pressureSet = 1  # (aka number of materials used)
...
if __name__ == '__main__':
    ...
    def thread_add_time():
        ...
        # if resync_type != False and decoded_data == 'PING':
    ...
    def thread_exec_command():
        global i
        global offset
        global resync_test_time_adjust
        global add_time
        global time_based_dict_final
        global real_time
