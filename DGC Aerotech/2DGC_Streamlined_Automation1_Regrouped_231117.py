...
gcode_txt_imported = '230908_GradientInfillV5_gcode.txt'  # "1DGC_Generate_Gradient_M1_gcode.txt" #"1DGC_Generate_Checkerboard_SwitchingNozzle_gcode.txt" #"1DGC_Generate_Checkerboard_M1.txt"
final_gcode_txt_export = gcode_txt_imported.replace('gcode','aerotech_test1')  # '230831_1mm_32_70_Gradient_diamond_lattice_aerotech.txt'
...
# print("time_dict_final = ", time_dict_final)
# print("command_dict_final_current = ", command_dict_final_current)
