...
gcode_txt_imported = '231103_DiscreteSwitchingMixingGradient_gcode.txt' #"1DGC_Generate_Gradient_M1_gcode.txt" #"1DGC_Generate_Checkerboard_SwitchingNozzle_gcode.txt" #"1DGC_Generate_Checkerboard_M1.txt"
