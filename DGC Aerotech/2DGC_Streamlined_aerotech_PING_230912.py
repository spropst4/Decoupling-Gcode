...
offset = 2.9#0.5 #2.92 #3.75 #2.5 #use a negative number to increase length of time/material being on (units in mm)
offset_initial = offset #5 #3.5
start_delay = 0 #(units in mm)

gcode_txt_imported = '230911_Generate_Checkerboard_SwitchingNozzle_gcode.txt' #"1DGC_Generate_Gradient_M1_gcode.txt" #"1DGC_Generate_Checkerboard_SwitchingNozzle_gcode.txt" #"1DGC_Generate_Checkerboard_M1.txt"
