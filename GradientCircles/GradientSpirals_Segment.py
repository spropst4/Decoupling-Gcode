...
if __name__ == '__main__':
    gcode_txt_input = 'Spiral_gcode.txt'
    export_file = 'TestSpiral_Gradient_gcode.txt'
...
port = 'serialPort1'
pressure_start = 25
pressure_incr = 0.0025
arc_segments = 1

set_pressure = pressurebox_setpress_str_command(port, pressure_start, True)
...
for i in range(len(input_line[0])):
    ...
    if G_list == 3 or G_list == 2:
        ...
        segmentCircleG3(input_line_current, arc_segments)
    elif var_line != []:
